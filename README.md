...
- Settings menu (⚙️) with 20 selectable color themes (Peach, Lavender Dream, Minty Fresh, Sunset, Sunrise, Pink Lemonade, Beach, Bubblegum, Forest, Autumn, Frost, Galaxy, Cyberpunk, Volcano, Midnight, Coral Reef, Rose Gold, Aurora, Cherry Blossom, Espresso) plus a fully custom theme you build from 4 picked colors, sound/haptics toggles, and a two-tap "reset all progress" option
...
- Warm pastel visual theme by default, with chunky, blocky display type, 19 alternate preset themes (including an Accessible theme built on the colorblind-safe Okabe-Ito palette), and a build-your-own custom theme
