...
- Weekly Challenge (📆, in the Menu) is a tougher numbered puzzle that stays the same for everyone all week, with Hard Mode's no-Undo/no-Reroll rules baked in as its twist. Has its own leaderboard tab, best score, and completion streak
